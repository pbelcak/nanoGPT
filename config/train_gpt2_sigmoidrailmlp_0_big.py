...
wandb_run_name='gpt2-sigmoidrailmlp-0-4-1-big'

# setup out dir
out_dir = "out/"+wandb_run_name

# 12 batch size * 1024 block size * 2 gradaccum * 8 GPUs * 4 nodes = 786,432 tokens
batch_size = 12
block_size = 1024
...
# this makes total number of tokens be 315B
warmup_iters = 3000
max_iters = 400000
